...
import { categoriesData, customersData, ecommerceProductsData, inventoryData, invoicesData, ordersData, sellersData } from '@/admin/assets/data/products';
import { activityStreamData, appsData, notificationsData } from '@/admin/assets/data/topbar';
import { sleep } from '@/admin/utils/promise';
import { dataTableRecords, pricingData, projectsData, timelineData, transactionsData } from '@/admin/assets/data/other';
import { emailsData, socialCommentsData, socialEventsData, socialGroupsData, socialPostsData, socialUsersData, teamMembers } from '@/admin/assets/data/social';
import { todoData } from '@/admin/assets/data/task';
