...
export const groupedBarChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    toolbar: {
...
export const negativeValueChartOpts = {
  chart: {
    height: 380,
    type: 'bar',
    stacked: true,
...
export const reversedChartOpts = {
  series: [{
...
export const customDataLabelsChartOpts = {
  chart: {
    height: 450,
    type: 'bar',
    toolbar: {
...
export const chartWithMarkerOpts = {
  series: [{
    name: 'Actual',
    data: [{
      x: '2017',
